...
namespace Sonauto
{
    public partial interface IGenerationsClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Sonauto.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::Sonauto.AutoSDKHttpResponse<global::Sonauto.OneOf<string, global::Sonauto.GenerationStatus>>> GetGenerationStatusAsResponseAsync(
            string taskId,
            bool? includeAlignment = default,
            global::Sonauto.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default);
