...
namespace Sonauto
{
    ...
    public sealed class AutoSDKClientOptions
    {
        ...
        /// </summary>
        public global::Sonauto.AutoSDKRetryOptions Retry { get; set; } = new global::Sonauto.AutoSDKRetryOptions();
        ...
        /// </summary>
        public global::System.Collections.Generic.List<global::Sonauto.IAutoSDKHook> Hooks { get; } =
            new global::System.Collections.Generic.List<global::Sonauto.IAutoSDKHook>();
        ...
        public global::Sonauto.AutoSDKClientOptions AddHook(
            global::Sonauto.IAutoSDKHook hook)
        {
        ...
        /// </summary>
        public global::Sonauto.IAutoSDKAuthorizationProvider? AuthorizationProvider { get; set; }
        ...
        public global::Sonauto.AutoSDKClientOptions UseAuthorizationProvider(
            global::Sonauto.IAutoSDKAuthorizationProvider provider)
        {
            AuthorizationProvider = provider ?? throw new global::System.ArgumentNullException(nameof(provider));
            if (Hooks.Find(static x => x is global::Sonauto.AutoSDKAuthorizationProviderHook) == null)
            {
                Hooks.Add(new global::Sonauto.AutoSDKAuthorizationProviderHook());
            }
    ...
    public readonly struct AutoSDKAuthorizationValue
    {
        ...
        public static global::Sonauto.AutoSDKAuthorizationValue Bearer(string token) => new(value: token, scheme: "Bearer");

        /// <summary>Convenience factory for an API-key header.</summary>
        public static global::Sonauto.AutoSDKAuthorizationValue ApiKeyHeader(string name, string value) =>
    ...
    public interface IAutoSDKAuthorizationProvider
    {
        ...
        global::System.Threading.Tasks.Task<global::System.Collections.Generic.IReadOnlyList<global::Sonauto.AutoSDKAuthorizationValue>?> ResolveAsync(
            global::Sonauto.AutoSDKHookContext context);
    }
...
#pragma warning restore CS0618
    ...
    /// </summary>
    public sealed class AutoSDKAuthorizationProviderHook : global::Sonauto.AutoSDKHook
    {
        /// <inheritdoc />
            ...
            global::Sonauto.AutoSDKHookContext context)
        {
            ...
            if (perRequest != null && perRequest.Count > 0)
            {
                ...
                global::Sonauto.AutoSDKHttpRequestOptions.StampAuthorizationOverride(context.Request);
                return;
            }
        ...
        private static void ApplyAuthorization(
            global::System.Net.Http.HttpRequestMessage request,
            global::Sonauto.AutoSDKAuthorizationValue authorization)
        {
    ...
    public sealed class AutoSDKRequestOptions
    {
        ...
        /// </summary>
        public global::Sonauto.AutoSDKRetryOptions? Retry { get; set; }
        ...
        /// </summary>
        public global::System.Collections.Generic.IReadOnlyList<global::Sonauto.AutoSDKAuthorizationValue>? Authorizations { get; set; }
    }
    ...
    /// </summary>
    public abstract class AutoSDKHook : global::Sonauto.IAutoSDKHook
    {
        /// <inheritdoc />
    ...
    public sealed class AutoSDKHookContext
    {
        ...
        /// </summary>
        public global::Sonauto.AutoSDKClientOptions ClientOptions { get; set; } = null!;

        /// <summary>
        /// The per-request runtime options.
        /// </summary>
        public global::Sonauto.AutoSDKRequestOptions? RequestOptions { get; set; }
    ...
    {
        internal static global::Sonauto.AutoSDKHookContext CreateHookContext(
            string operationId,
            string methodName,
            string pathTemplate,
            string httpMethod,
            ...
            global::Sonauto.AutoSDKClientOptions clientOptions,
            global::Sonauto.AutoSDKRequestOptions? requestOptions,
            int attempt,
            int maxAttempts,
            bool willRetry,
        ...
        {
            return new global::Sonauto.AutoSDKHookContext
            {
        ...
        internal static global::System.TimeSpan GetRetryDelay(
            ...
            int attempt)
        {
            var retryOptions = requestOptions?.Retry ?? clientOptions.Retry ?? new global::Sonauto.AutoSDKRetryOptions();
        ...
        private static global::System.TimeSpan ClampRetryDelay(
            global::System.TimeSpan delay,
            global::Sonauto.AutoSDKRetryOptions retryOptions)
        {
        ...
        private static async global::System.Threading.Tasks.Task InvokeHooksAsync(
            global::Sonauto.AutoSDKClientOptions clientOptions,
            global::System.Func<global::Sonauto.IAutoSDKHook, global::Sonauto.AutoSDKHookContext, global::System.Threading.Tasks.Task> callback,
            global::Sonauto.AutoSDKHookContext context)
        {
