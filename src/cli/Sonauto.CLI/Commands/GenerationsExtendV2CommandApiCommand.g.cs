...
Continues an existing audio clip by generating before or after it.");
        ...
        command.SetAction(async (ParseResult parseResult, CancellationToken cancellationToken) =>
            await CliRuntime.RunAsync(async () =>
            {
                        ...
                        var extendDuration = CliRuntime.WasSpecified(parseResult, ExtendDuration) ? parseResult.GetValue(ExtendDuration) : (__requestBase is { } __ExtendDurationBaseValue ? __ExtendDurationBaseValue.ExtendDuration : default);
                        var cropDuration = CliRuntime.WasSpecified(parseResult, CropDuration) ? parseResult.GetValue(CropDuration) : (__requestBase is { } __CropDurationBaseValue ? __CropDurationBaseValue.CropDuration : default);
