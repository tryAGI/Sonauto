...
internal static class CliRuntime
{
    ...
    public static async Task<global::Sonauto.SonautoClient> CreateClientAsync(ParseResult parseResult, CancellationToken cancellationToken = default)
    {
    ...
    private static async Task WriteApiExceptionAsync(global::Sonauto.ApiException exception)
    {
        var builder = new StringBuilder();
