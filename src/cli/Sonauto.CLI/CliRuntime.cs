...
{
    private const string UserSecretsId = "Sonauto.CLI";
    private const string UserSecretApiKeyName = "SONAUTO_API_KEY";
    private static readonly string[] ApiKeyEnvironmentVariables = [@"SONAUTO_API_KEY"];
    private const string CredentialFileDirectoryName = ".sonauto";

    public static async global::System.Threading.Tasks.Task<global::Sonauto.SonautoClient> CreateClientAsync(ParseResult parseResult, CancellationToken cancellationToken = default)
    {
        ...
        var authorizations = string.IsNullOrWhiteSpace(apiKey)
            ? new global::System.Collections.Generic.List<global::Sonauto.EndPointAuthorization>()
            : new global::System.Collections.Generic.List<global::Sonauto.EndPointAuthorization>
            {
        CreateAuthorization(
            type: "Http",
        ...
        return new global::Sonauto.SonautoClient(
            httpClient: null,
            baseUri: baseUri,
    ...
    private static global::Sonauto.EndPointAuthorization CreateAuthorization(
        string type,
        string schemeId,
        string location,
        string name,
        string value)
    {
        var authorization = new global::Sonauto.EndPointAuthorization
        {
            Type = type,
            Location = location,
            Name = name,
        ...
        var schemeIdProperty = typeof(global::Sonauto.EndPointAuthorization).GetProperty("SchemeId");
    ...
    public static async global::System.Threading.Tasks.Task<int> RunAsync(Func<global::System.Threading.Tasks.Task> action, CancellationToken cancellationToken = default)
    {
        ...
        catch (global::Sonauto.ApiException exception)
        {
    ...
    private static Uri? ResolveBaseUri(ParseResult parseResult)
    {
        ...
        {
            baseUrl = Environment.GetEnvironmentVariable("SONAUTO_BASE_URL");
        }
    ...
    private static async global::System.Threading.Tasks.Task WriteApiExceptionAsync(global::Sonauto.ApiException exception)
    {
        var builder = new StringBuilder();
